...
from tinysoul.kernel.action.core.call import ActionCall, ActionFramework, ExecutionFact, ExecutionState
...
from tinysoul.kernel.context.trace import PendingInputs, TraceKind, TurnTraceHeap
from tinysoul.kernel.context.working import (
    Milestone,
    TodoItem,
    TodoStatus,
    WorkingContext,
...
def test_background_patch_rejects_duplicate_links() -> None:
    ...
    problem = background.check_patch(
        BackgroundPatch(
            load_links=("home:skills@x", "home:skills@x")
        ),
        loadable_links=("home:skills@x",),
        evictable_links=("home:skills@x",),
    )
