...
@pytest.mark.parametrize(
    "reason", [CONTEXT_COMPRESSION_REQUIRED, LLM_CONTEXT_CAPACITY_EXCEEDED]
)
async def test_llm_action_context_pressure_preserves_owner_transfer(
    reason: str,
) -> None:
    ...
    assert exc_info.value is pressure
