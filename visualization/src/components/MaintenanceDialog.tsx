      ...
      <div className="modal">
        ...
        <div className="modal-body">
          <p className="text-sm mb-3">
            A Home Maintenance change is pending. Review the change and choose an action.
          </p>
        ...
        <div className="modal-footer">
          ...
          <button className="btn btn-danger" onClick={() => void submit("discard")}>
            Discard
          </button>
          <button className="btn btn-primary" onClick={() => void submit("apply")}>
            Apply
          </button>
        </div>
      </div>
