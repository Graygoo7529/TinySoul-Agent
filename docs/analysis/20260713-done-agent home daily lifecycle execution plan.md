...
后续说明：Stage 8.1 中 Agent/WHAT/WHY Top Link 携带 `.md` 的选择已由 `20260715-done-home top link identity refactor plan.md` 替代；Memory Link 携带 `.md` 的选择已由 `20260715-done-memory link identity refactor plan.md` 替代。当前 canonical 语义以 `AGENT.md`、`docs/design/agent_home.md`、`docs/design/memory.md` 与对应后续计划为准。
