...
配套文档：[前三轮 Review 与 R4 前基础补强方案](20260920-r1-r3-review-and-pre-r4-foundation-plan-latest.md)。2026-09-20 用户已确认持续整理多历史 Turn/已有地图的方向，以及受信独立主机的执行假设；本次进一步细化数据与接口方案，未执行代码补强。两份文档分别负责整体目标和 R4 前可实施切片，不将待实施内容标为完成。
