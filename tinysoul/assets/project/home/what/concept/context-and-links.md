...
The effective allowlisted Agent Context pages are also automatic Background defaults: <home:agent@context/background>, <home:agent@context/turn-trace>, <home:agent@context/working>, and <home:agent@context/workspace>. They explain stable visibility and Link semantics; domain/action HOW continues to own operational action guidance.
