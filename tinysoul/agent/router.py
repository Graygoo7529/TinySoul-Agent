...
class EventRouter:
    ...
    def subscribe(self, subscription_id: str, kind: EventKind, target: EventTarget) -> None:
        if not subscription_id or not isinstance(kind, EventKind) or not callable(target):
