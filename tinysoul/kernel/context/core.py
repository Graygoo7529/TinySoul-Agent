...
from .signals import (
    SIGNAL_INPUT_APPEND, SIGNAL_TRACE_APPEND, SIGNAL_WORKING_PATCH, InputAppend, TraceAppend,
...
class InputsSegment:
    ...
    async def prepare(self, updates: tuple[InputAppend, ...]) -> PendingInputs:
        ...
        for update in updates:
            candidate.add(update.text, input_id=update.input_id, reply_to=update.reply_to)
        return candidate
...
def core_registrations(
    *, identity: str, journal: str, inputs: InputsSegment, plan: PlanSegment, trace: TraceSegment,
    ...
    return (
        ...
        SegmentRegistration(INPUTS, CoreSegmentProvider(inputs), SIGNAL_INPUT_APPEND, InputAppend, parse_input_append_signal),
