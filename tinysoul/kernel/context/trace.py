...
from tinysoul.kernel.action.core.call import ActionCall, ExecutionFact, ExecutionState
...
class PendingInputs:
    ...
    def add(self, text: str, *, merged: bool = False, input_id: str = "", reply_to: str = "") -> "PendingInput":
        if not text:
