...
from .engine import WorkspaceArchiveView
...
def declare_workspace(
    workspace: WorkspaceService, *, bus: SignalBus, llm_action: LLMActionTaskRunner,
    archive_source: Callable[[], WorkspaceArchiveView | None] | None = None,
) -> PluginDeclaration:
    return PluginDeclaration(
        "workspace", services=(Service(WorkspaceService, workspace),),
