...
- `home:agent@<path>.md`, `home:what@entity|concept/<path>.md`, `home:why@<path>.md`, and `home:how@<skill>` are Top Links. Load one or more currently exposed Top Links with `load_background` when their bodies are relevant.
...
Related concept: <home:what@concept/context-and-links.md>.
